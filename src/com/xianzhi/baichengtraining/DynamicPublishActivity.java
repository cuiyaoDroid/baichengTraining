...
public class DynamicPublishActivity extends BaseSwipeBaceActivity{
	private LinearLayout linear_layout;
	private static final String[] titles=new String[]{"接收人",	"部门"
		,"发布时间","问题类别","提示描述"};
	private static final String[] contents=new String[]{"于炳仁","平台站"
	...
	protected void initContentData() {
		...
		for(int i=0;i<titles.length&&i<contents.length;i++){
			View cell=getLayoutInflater().inflate(R.layout.cell_publish,null );
